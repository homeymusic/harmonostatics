test_that("frequency is structured as we expect", {
  ...
  expect_equal(t$numerator,c(1,16,9,6,5,4,sqrt(2),3,8,5,16,15,2))
  expect_equal(t$denominator,c(1,15,8,5,4,3,1,2,5,3,9,8,1))
  expect_equal(o$numerator,rev(c(1,15,8,5,4,3,1,2,5,3,9,8,1)))
  expect_equal(o$denominator,rev(c(1,16,9,6,5,4,sqrt(2),3,8,5,16,15,2)))
