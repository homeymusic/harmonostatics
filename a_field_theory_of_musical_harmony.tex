...
\begin{equation}
  B=\frac{\beta}{C}, \ \beta=\{-1,0,1\}  \label{brillianceEq}
\end{equation}

\begin{equation}
  C_{chord}=\frac{1}{N}\sum\limits_{i=0}^{N}\sum\limits_{j=i+1}^{N} C_{\left|i-j\right|}  \label{consonanceChordEq}
\end{equation}

\begin{equation}
  B_{chord}=\frac{1}{N}\sum\limits_{i=0}^{N}\sum\limits_{j=i+1}^{N}\frac{ B_{i}+B_{j}}{2}   \label{brillianceChordEq}
\end{equation}
...
\begin{enumerate}
\item symmetry around the 2nds, 3rds, 6ths and 7ths (is there a curve on the plot?)
\end{enumerate}
