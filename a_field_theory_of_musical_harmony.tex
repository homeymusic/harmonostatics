...
\subsection{Musical Harmony}

\begin{equation}
  \boldsymbol{H}=\eta\boldsymbol{\nabla}\phi \label{harmonyEq}  
\end{equation}

\begin{equation}
  \boldsymbol{H}=(C\boldsymbol{\hat{c}}+B\boldsymbol{\hat{b}}) \label{consonanceEq}
\end{equation}

\begin{equation}
  \boldsymbol{\nabla \cdot H}=\eta\boldsymbol{\nabla^2}\phi = \rho  \label{poissonEq}
\end{equation}
