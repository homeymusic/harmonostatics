...
test_that("PE of tonic intervals looks good", {
  ...
  p = plot_potential_energy(intervals_list(),y=0,home=0,unlist=TRUE,columns=c("semitone_x","potential_energy"),title=title,include_names=FALSE)
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(intervals_list(),y=0,home=0,unlist=TRUE,columns=c("semitone_x","potential_energy"),symmetrical=FALSE,x_expansion_mult=0.2,title=title)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "semitone_x")
  expect_identical(p$labels$y, "potential_energy")

  p = homey_plot_potential_energy(intervals_list(),y=0,home=0,unlist=TRUE,columns=c("semitone_x","potential_energy"),symmetrical=FALSE,x_expansion_mult=0.2,title=title,include_names=FALSE)
  expect_identical(p$labels$x, "semitone_x")
  expect_identical(p$labels$y, "potential_energy")
...
test_that("PE of octave intervals looks good", {
  ...
  p = plot_potential_energy(intervals_list(),y=12,home=12,unlist=TRUE,columns=c("semitone_x","potential_energy"),title=title,include_names=FALSE)
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(intervals_list(),y=12,home=12,unlist=TRUE,columns=c("semitone_x","potential_energy"),symmetrical=FALSE,x_expansion_mult=0.2,title=title)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "semitone_x")
  expect_identical(p$labels$y, "potential_energy")
...
test_that("lydian PE look good", {
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=lydian_tonic_chords(),y=lydian_tonic_chords()[1]%>%unlist,home=0,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
...
test_that("ionian PE look good", {
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=ionian_tonic_chords(),y=c(0,4,7),home=0,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
  ...
  p = plot_potential_energy(x=ionian_tonic_chords(),y=c(0,4,7),home=0,columns=c("semitone_x","potential_energy"),title=title)
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=ionian_tonic_chords(),y=c(0,4,7),home=0,columns=c("semitone_x","potential_energy"), title=title, symmetrical=FALSE,x_expansion_mult=0.1,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "semitone_x")
  expect_identical(p$labels$y, "potential_energy")

  p = plot_potential_energy(x=ionian_tonic_chords(),y=c(0,4,7),home=0,columns=c("semitone_x","potential_energy"),title="ionian tonic chords")
  expect(p, "plot is probably ok")
  p = plot_potential_energy(x=ionian_tonic_chords.in_one_level(),y=c(0,4,7),home=0,columns=c("semitone_x","potential_energy"),title="ionian tonic chords level 0")
  expect(p, "plot is probably ok")
...
test_that("mixolydian PE look good", {
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=mixolydian_tonic_chords(),y=mixolydian_tonic_chords()[1]%>%unlist,home=0,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=mixolydian_tonic_sixth_chords(),y=mixolydian_tonic_sixth_chords()[1]%>%unlist,home=0,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
...
test_that("dorian PE look good", {
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=dorian_tonic_chords(),y=dorian_tonic_chords()[1]%>%unlist,home=0,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=dorian_octave_chords(),y=dorian_octave_chords()[1]%>%unlist,home=12,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
...
test_that("aeolian PE look good", {
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=aeolian_tonic_chords(),y=c(0,3,7),home=0,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
  ...
  p = plot_potential_energy(x=aeolian_tonic_chords(),y=c(0,3,7),home=0,columns=c("semitone_x","potential_energy"),title=title)
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=aeolian_tonic_chords(),y=c(0,3,7),home=0,columns=c("semitone_x","potential_energy"), title=title, symmetrical=FALSE,x_expansion_mult=0.1,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "semitone_x")
  expect_identical(p$labels$y, "potential_energy")

  p = plot_potential_energy(x=aeolian_tonic_chords(),y=c(0,3,7),home=0,columns=c("semitone_x","potential_energy"),title="ionian tonic chords")
  expect(p, "plot is probably ok")
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=aeolian_octave_chords(),y=aeolian_octave_chords()[1]%>%unlist,home=12,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
...
test_that("phrygian chords look good", {
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=phrygian_tonic_chords(),y=c(0,3,7),home=0,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=phrygian_octave_chords(),y=c(12,8,5),home=12,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
...
test_that("locrian PE look good", {
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=locrian_tonic_chords(),y=locrian_tonic_chords()[1]%>%unlist,home=0,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
  ...
  expect(p, "plot is probably ok")
  p = homey_plot_potential_energy(x=locrian_octave_chords(),y=locrian_octave_chords()[1]%>%unlist,home=12,columns=c("brightness","potential_energy"), title=title, symmetrical=TRUE,y_lim_max=100)
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".svg",sep="")))
  suppressMessages(ggplot2::ggsave(paste("./homey_plots/",gsub(" ", "_", title),".png",sep="")))
  expect_identical(p$labels$x, "brightness")
  expect_identical(p$labels$y, "potential_energy")
