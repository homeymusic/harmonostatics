...
\item pitch classes when we go up and down octaves pitch classes emerge on the C-B plots: they hang out in the same area: look at major 3rd and minor 6th across a few octaves.
...
\begin{equation}
  \boldsymbol{F} = -\boldsymbol{\nabla}\Phi + \boldsymbol{\nabla}\times\boldsymbol{A} \label{helmholtzEq}
\end{equation}
...
\begin{equation}
  \boldsymbol{H}=\boldsymbol{R}(\theta)\boldsymbol{\nabla}\psi, \ \theta = \frac{\pi}{4}  \label{harmonyEq}
\end{equation}
